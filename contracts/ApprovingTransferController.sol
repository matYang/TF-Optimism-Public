...
// File: contracts/transferController/ApprovingTransferController.sol



/**
 * @title ApprovingTransferController
 * @dev Approves all transfers
*/
contract ApprovingTransferController is TransferController {
